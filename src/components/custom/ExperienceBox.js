    ...
    return (
        <div className="prose items-center dark:prose-invert">
            <div className="grid grid-cols-1 mt-5">
                {
                    data.map((exp, index) => (
                        < div className="px-4 rounded-2xl" key={index}>
                            <div className="flex gap-5">
                                {/* Icon */}
                                <div className="flex flex-col items-center">
                                    <span className={`${exp.icon_color} bg-slate-100 rounded-full px-3 py-2 dark:bg-slate-800`}><i className={exp.icon}></i></span>
