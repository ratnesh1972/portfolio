...
import resume from '../../assets/Ratnesh_Patil.pdf';
        ...
        <section id="experience" className="pt-20 px-5 lg:px-0 lg:py-20 dark:bg-slate-900">
            ...
            <div className="container mx-auto">
                ...
                <div className="text-center pt-10 pb-5">
                    <a className="rounded-lg bg-cyan-500 shadow-lg shadow-cyan-500/50 text-white text-center px-10 py-3 w-48" href={resume} download rel="noreferrer"><i class="fa-solid fa-download fa-lg"></i> Download My Resume</a>
                </div>
